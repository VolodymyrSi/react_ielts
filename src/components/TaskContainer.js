  ...
  return (
    <div>
      ...
      <div className="taskFileAndForm">
        ...
        {taskNumber === 1 && <TaskForm input={userInput1} setInput={setUserInput1} value={userInput1}/>}
      </div>
      <div className="taskFileAndForm">
        {taskNumber === 2 && (
          <TaskFile
...
Give reasons for your answer and include any relevant examples from your own knowledge and experience."
        ...
        {taskNumber === 2 && <TaskForm input={userInput2} setInput={setUserInput2} value={userInput2}/>}
      </div>
